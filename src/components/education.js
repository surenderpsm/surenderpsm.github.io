...
const EducationItem = ({data})=> {
    ...
    return(
        <div className="bg-transperant dark:bg-black flex flex-col transition-colors duration-1000">
            <div className="bg-transparent flex flex-row justify-start transition-colors duration-1000">
                <div>
                ...
                <div className="flex flex-row justify-between basis-f">
                  <div className="flex items-center">
                    <span className="font-mono text-2xl sm:text-3xl md:text-4xl text-left">
                      {institution}
                    </span>
                  </div>
